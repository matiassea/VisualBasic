...
Sub Create_Pivot_Table_Catalogo()
...
Worksheets("Catalogo").Delete
Sheets.Add Before:=ActiveSheet
ActiveSheet.Name = "Catalogo"
Application.DisplayAlerts = True
Set PSheet = Worksheets("Catalogo")
...
(TableDestination:=PSheet.Cells(1, 1), TableName:="Catalogo")

'Insert Report Filter (estos son los filtros)

With ActiveSheet.PivotTables("Catalogo").PivotFields("Cantidad de lineas")
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Compra realizada")
.Orientation = xlPageField
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Pais")
.Orientation = xlPageField
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Tipo de compra")
.Orientation = xlPageField
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Area de compra")
.Orientation = xlPageField
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Dias Pen")
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Taxonomia")
...
With ActiveSheet.PivotTables("Catalogo").PivotFields("Lineadistribucion")
